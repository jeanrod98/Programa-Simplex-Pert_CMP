...
class Simplex(QMainWindow):
                ...
                try:
                    ...
                    for i in range(8):
                        ...
                        if i >= 2:
                            ...
                            itemFila5 = self.ui.matriz.item(5,i).text()
                            Fila6.append(itemFila5)
                            #Extrae los valores de la fila 6
                            itemFila6 = self.ui.matriz.item(6,i).text()
                            Fila7.append(itemFila6)
                    ...
                    doc = SimpleDocTemplate("Reporte_Simplex3.pdf", pagesize = A4, topMargin=12)
                    alineacionTitulo = ParagraphStyle(name="centrar", alignment=TA_CENTER, fontSize=20, leading=40)
                    alineacionAutor = ParagraphStyle(name="centrar", alignment=TA_CENTER, fontSize=11, leading=40)
                    ...
                    t.setStyle([
                                ...
                                ('BACKGROUND', (0, 2), (-1, 0), colors.lightgreen),
                                ('BACKGROUND', (1, 0), (1, 6), colors.lightgreen),
                                ('BACKGROUND', (7, 5), (7, 5), colors.lightskyblue),
                        ])
                    ...
                    story.append(Spacer(0,15))
                    doc.build(story)
                    os.system("Reporte_Simplex3.pdf")
        ...
        if numRestriccion == 2:
            ...
            if arrayZ[0] <= 0 and arrayZ[1] <= 0 and arrayZ[2] <= 0 and arrayZ[3] <= 0 :
                ...
                if numMayor == arrayZj[0]:
                    ...
                    #Determinamos si la variable saliente es j1 o j2
        ...
        if arrayZ[0] <= 0 and arrayZ[1] <= 0 and arrayZ[2] <= 0 and arrayZ[3] <= 0 :
            ...
            if numMayor == arrayZj[0]:
                ...
                if variableSaliente*arrayCeldas[1] == arrayBi[1]:
                 ...
                 #Encontramos la variable entrante
                self.ui.label_varEntra.setText(f'El número de la variable entrante es {"{:.3f}".format(numMayor)}, J1')
                ...
                if variableSaliente*arrayCeldas[1] == arrayBi[1]:
                 ...
                 #Encontramos la variable entrante
                self.ui.label_varEntra.setText(f'El número de la variable entrante es {"{:.3f}".format(numMayor)}, J2')
    ...
    def datos_tabla_actual_2r(self):
        ...
        if arrayZ[0] <= 0 and arrayZ[1] <= 0 and arrayZ[2] <= 0 and arrayZ[3] <= 0 and arrayZ[4] <= 0:
            ...
            if numMayor == arrayZj[0]:
                ...
                self.ui.label_varEntra.setText(f'El número de la variable entrante es {"{:.3f}".format(numMayor)}, J3')
    ...
    def nuevo(self):
        ...
        self.ui.funObjX1.setText("")
        self.ui.funObjX2.setText("")
    ...
    def mostrarDatos(self):
        try:
            ...
            if numRestriccion == 1:
                ...
                funObX1 = self.ui.funObjX1.text()
                funObX2 = self.ui.funObjX2.text()
                ...
                funObX1 = float(self.ui.funObjX1.text())
                funObX2 = float(self.ui.funObjX2.text())
                ...
                self.ui.matriz.setItem(1,4, QTableWidgetItem("J1")) 
                self.ui.matriz.setItem(1,5, QTableWidgetItem("J2")) 
                self.ui.matriz.setItem(1,6, QTableWidgetItem("Bi")) 
                #Fila 2
                self.ui.matriz.setItem(2,0, QTableWidgetItem("0"))
                self.ui.matriz.setItem(2,1, QTableWidgetItem("J1"))
                ...
                self.ui.matriz.setItem(3,1, QTableWidgetItem("J2"))
                ...
                self.ui.matriz.setItem(1,4, QTableWidgetItem("J1")) 
                self.ui.matriz.setItem(1,5, QTableWidgetItem("J2")) 
                self.ui.matriz.setItem(1,6, QTableWidgetItem("J3")) 
                ...
                self.ui.matriz.setItem(4,1, QTableWidgetItem("J3"))
    ...
    #Funcion Agregar un Combo Box a la celda
    ...
    def generarModelo(self):
        ...
        if numRestriccion ==2:
            ...
            #Agregar un Combo Box a la celda
